...
{
    public const DiscountItemKey = 'cart_discount';

    public function __construct(
        protected readonly float $discountPercentage,
        protected readonly int $minimumQuantity
    ) {
    }
